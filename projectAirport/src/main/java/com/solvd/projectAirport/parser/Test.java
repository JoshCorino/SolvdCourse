...
public class Test {
	 ...
	 public static void main(String[] args) {
		...
		log.info("Getting data with DOM");
	 	DomParserDemo dp =new DomParserDemo();
		...
		try {
			mapper.writeValue(new File("src/main/resources/demo.json"), c);
		...
		try {
			Country countryGetted = mapper.readValue(new File("src/main/resources/demo.json"), Country.class);
