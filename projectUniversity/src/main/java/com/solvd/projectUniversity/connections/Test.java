...
public class Test {
	...
	public static void main(String[] args) {
			...
			Future<String> mf1 = eService.submit(new MyCallable<String>("Callable of future 1"));
			Future<String> mf2 = eService.submit(new MyCallable<String>("Callable of future 2"));
